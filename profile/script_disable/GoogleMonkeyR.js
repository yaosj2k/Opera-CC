...
// @scriptsource   http://google.monkeyr.com/script/1.4.4/googlemonkeyr.user.js
/* StartHistory
...
//        }
    ...
    {
        this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); #cnt {max-width: none !important;} #subform_ctrl {margin-left:176px; margin-right:269px; max-width: 695px;} #tsf {margin: 0 !important} #foot{margin:auto} #ofr{margin:0.33em 0 12px 0}");
        if(UIL.Config.getHideSearch())
        {
            this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); #tsf, #sfcnt {display:none!important;} #subform_ctrl{margin-left:15px;min-height:0} .lsd{top:3px;width:auto;right:65px} #cnt{padding:0} #bfl");
...
//                nextLink.id="mynextlink";
    ...
    buildResultTable : function()
    {
        ...
        var searchesRelatedTo = UIL.Config.getSearchesRelatedTo() &&
            document.getElementByXPath("//div[@id='res']//div[@id='brs']");
        ...
        var showingResultFor = document.getElementByXPath("//*[@id='res']/p[1]//span[@class='spell']/ancestor::p");
        var moreResultFor = document.getElementByXPath("//*[@id='res']/div[@class='med']");
		var duplicate = didYouMean || showingResultFor || moreResultFor || false;
        if(duplicate)
        {
...
//console.log(this.imagePreview)
    ...
    processResults : function(responseText)
    {
		...
		var imgs = document.getElementsByXPath(".//img[@id=@class]");
		for (i = 0; (img = imgs[i++]);)
		{
