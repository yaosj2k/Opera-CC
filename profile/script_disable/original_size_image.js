...
/*---------------------------设置结束---------------------------------*/
	...
	function create_preview(x, y, imgLink){
		if(imgLink !== null){
			...
			preview_div.setAttribute('style', 'border: 1px solid gray !important; background-color: ' + PREVIEW_DIV_COLOR + ' !important; position: absolute !important; z-index: 9999 !important; padding: 5px !important;');
